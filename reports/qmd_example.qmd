...
The Python programming language (@Python) and the following Python
packages were used to perform the analysis: pandas (@pandas), 
altair (@altair), and click (@click). The report was generated using 
